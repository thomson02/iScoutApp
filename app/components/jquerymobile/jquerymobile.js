...
// "vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel"
    ...
    (function( $, window, document, undefined ) {
        ...
        function createVirtualEvent( event, eventType ) {
            ...
            // https://github.com/jquery/jquerymobile/issues/3280
        ...
        $.mobile.changePage = function( toPage, options ) {
            ...
            transitionPages( toPage, fromPage, settings.transition, settings.reverse )
                .done(function( name, reverse, $to, $from, alreadyFocused ) {
                    ...
                    // https://github.com/jquery/jquerymobile/issues/2965
                    if ( !alreadyFocused ) {
    ...
    (function( $, undefined ) {
        ...
        $.widget( "mobile.collapsibleset", $.mobile.widget, {
            ...
            _init: function() {
                ...
                // That was causing https://github.com/jquery/jquerymobile/issues/4116
...
//https://github.com/jquery/jquerymobile/issues/1617
    ...
    (function( $, undefined ) {
        ...
        $.widget( "mobile.button", $.mobile.widget, {
            ...
            _create: function() {
                ...
                // TODO: Post 1.1--once we have time to test thoroughly--any classes manually applied to the original element should be carried over to the enhanced element, with an `-enhanced` suffix. See https://github.com/jquery/jquerymobile/issues/3577
    ...
    (function( $, undefined ) {
        ...
        $.widget( "mobile.popup", $.mobile.widget, {
            options: {
                ...
                //      https://github.com/jquery/jquerymobile/issues/4784
                //
            ...
            _open: function( options ) {
                ...
                if ( this.options.overlayTheme && androidBlacklist ) {
                    /* TODO:
                     ...
                     https://github.com/jquery/jquerymobile/issues/4816
                     https://github.com/jquery/jquerymobile/issues/4844
                     https://github.com/jquery/jquerymobile/issues/4874
                     */
    ...
    (function( $, window, undefined ) {
        ...
        $(function() {
            ...
            if ( !$.support.cssPointerEvents ) {
                ...
                // https://github.com/jquery/jquerymobile/issues/3558
